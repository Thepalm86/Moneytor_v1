        ...
        <div className="relative">
          ...
          <Input
            ...
            className={cn(
              ...
              isFloating && 'pb-2 pt-6',
              !isFloating && 'pb-4 pt-4',
          ...
          <label
            className={cn(
              ...
              startIcon && 'left-12',
              isFloating ? 'top-2 text-xs font-medium' : 'top-1/2 -translate-y-1/2 text-base',
...
export const MobileFloatingTextarea = React.forwardRef<
  HTMLTextAreaElement,
    ...
    <div className={cn('relative', className)}>
      <div className="relative">
        ...
        <label
          className={cn(
            'pointer-events-none absolute left-4 text-gray-500 transition-all duration-200',
            isFloating ? 'top-2 text-xs font-medium' : 'top-4 text-base',
            focused && !error && 'text-blue-600',
            error && 'text-red-600'
          )}
        >
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            className={cn(
              'h-14 w-full justify-between rounded-xl border-2 text-left font-normal',
              !value && 'text-muted-foreground',
              error && 'border-red-500 ring-2 ring-red-500/20'
            )}
          >
            <div className="flex flex-col items-start">
              <span className="mb-0.5 text-xs font-medium text-gray-500">{label}</span>
              <span className="text-base">{value ? format(value, 'PPP') : placeholder}</span>
            </div>
